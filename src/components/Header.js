      ...
      <Navbar expand="lg" variant="dark">
        ...
        <Navbar.Collapse id="basic-navbar-nav" className="justify-content-end">
          <StyledNav style={{ fontSize: "1rem" }} className="m-auto">
            <a href="#experience" className="m-3">
              Experience
            </a>
          ...
          <Container fluid className="p-0">
            <Row>
              <Col xs={7}>
                ...
                <p>
                  studying computer science at Yale. For any inquiries, you can
                  reach me at{" "}
                  <a
                    style={{ textDecoration: "none" }}
                    href="mailto:benjamin.chen@yale.edu"
                  >
                    <span style={{ color: "var(--color-peach)" }}>
                      benjamin.chen@yale.edu.
                    </span>
                  </a>
                </p>
                <Row style={{ display: "flex", justifyContent: "flex-start" }}>
                  <StyledIcon
                    src={github_icon}
                    onClick={() => newTab(my_github_url)}
                  />
                  <StyledIcon
                    src={linkedin_icon}
                    onClick={() => newTab(my_linkedin_url)}
                  />
                  <StyledIcon
                    src={file_icon}
                    onClick={() => newTab(resumePDF)}
                  />
                </Row>
              </Col>
